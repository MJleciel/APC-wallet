    ...
    return (
        <>
            ...
            <div class="d-lg-none d-md-none d-block w-100">
                <section class="site_section term_service mobile_add_token text-white mobile_login d-flex align-items-center sidebar-width terms_services">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8 col-md-10 col-sm-12 col-12 text-left text-white site_scale">
                                <div class="text-center  mb-4">
                                ...
                                <div class="wallet_note text-center wallet_mobile">
                                    <div class="walet_title px-3 pt-2">
                                        <h3 class="m-0"> Terms of Services</h3>
                                    </div>


                                    <div class="crypto_account_detail my-3 d-block text-left">
                                        <h3 class="text-start">LEGAL DISCLAIMER</h3>
                                    ...
                                    <div class="submit_sec p-3">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-lg-center text-md-center text-center">
                                                {/* <a href="#" onClick={()=>{navigate('/')}} class="btn btn-primary w-auto">Reject</a> */}
                                                <button onClick={() => { navigate('/') }} class="btn-danger">Accept</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
