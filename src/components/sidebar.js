...
import { MdOutlineCardMembership, MdToken } from 'react-icons/md';
            ...
            <div  >
                <Sidebar className="main-sidebar" id="ms_bar">
                    ...
                    <Menu>
                        ...
                        <MenuItem active={window.location.pathname === "/overview"} onClick={() =>{collaspeClosed();navigate("/overview")} }><BsPieChartFill />Overview</MenuItem>
                        <MenuItem active={window.location.pathname === "/wallet"} onClick={() =>{collaspeClosed(); navigate("/wallet")}}> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
