                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-field mb-2">
                                                <input type="email" id="secure" placeholder="Email" />
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-field mb-2">
                                                <input type="password" id="secure" placeholder="Password" />
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-field mb-2">
                                                <input type="password" id="secure" placeholder="Repeat Password" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="submit_sec p-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-12 text-lg-end text-md-end text-left">
                                        ...
                                        <a onClick={()=>navigate('/select')} class="btn btn-primary w-auto transparent_button">OK</a>
                                    </div>
                                </div>
                            </div>
                        </div>
